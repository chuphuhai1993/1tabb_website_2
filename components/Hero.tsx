        ...
        <section className="relative min-h-[85vh] flex items-center justify-center px-6 pt-20">
            <div className="max-w-6xl mx-auto text-center relative z-10">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-6">
                    ...
                    <button className="glass-button px-8 py-4 rounded-full font-medium text-black dark:text-white hover:bg-white dark:hover:bg-white/10 hover:scale-[1.05] transition-all duration-300 flex items-center gap-2 group hover:shadow-[0_0_60px_-5px_rgba(0,0,0,0.2)] dark:hover:shadow-[0_0_60px_-5px_rgba(255,255,255,0.2)]">
