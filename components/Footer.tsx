...
const Footer: React.FC = () => {
    ...
    const sitemapLinks = [
        ...
        t.footer.sitemap.vision,
        t.footer.sitemap.ecosystem,
        t.footer.sitemap.careers
    ];
            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="md:col-start-3">
                        <h5 className="font-mono text-[10px] font-bold uppercase tracking-[0.2em] text-black/50 dark:text-white/30 mb-6">{t.footer.sitemap.title}</h5>
                    ...
                    <div>
                        <h5 className="font-mono text-[10px] font-bold uppercase tracking-[0.2em] text-black/50 dark:text-white/30 mb-6">{t.footer.legal.title}</h5>
                        <ul className="space-y-3 text-sm text-black/50 dark:text-white/60">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-4 pt-8 border-t border-white/5">
                    <p className="font-mono text-[10px] text-black/50 dark:text-white/20 uppercase tracking-widest">{t.footer.copyright}</p>
                    <p className="font-mono text-[10px] text-black/50 dark:text-white/20 uppercase tracking-widest">{t.footer.designedWith} <span className="text-red-500/50">♥</span> 1TABB</p>
                </div>
            </div>
        </footer>
    );
